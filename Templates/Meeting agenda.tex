...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Meeting announced in honor of the statues / \emph{Fråga om mötets stadgeenliga utlysande}
		...
		\begin{enumerate}
			...
			% \item Second item pending since last meeting
			% \item Etc...
		\end{enumerate}
		% \item First additional subject goes here
		% \item Second additional subject goes here
